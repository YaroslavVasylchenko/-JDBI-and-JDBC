...
public abstract class ThekioskCode {
    ...
    public ThekioskCode(ConstructorParams testConstructorParams) {
    ...
    public static void main(String[] args) {
        ...
        ConstructorParams params = new ConstructorParams(6003, 543, "2023-07-24", "2023-07-25", 1);
        ThekioskCode customKiosk = new ThekioskCode(params) {
